...
export default class extends BaseSchema {
  ...
  async down() {
    ...
    await this.db.rawQuery(
      `ALTER TABLE "Players" ADD COLUMN IF NOT EXISTS "SenhaHash" BYTEA NOT NULL DEFAULT ''`
    )
    await this.db.rawQuery(
      `ALTER TABLE "Players" ADD COLUMN IF NOT EXISTS "SenhaSalt" BYTEA NOT NULL DEFAULT ''`
    )
  }
}
