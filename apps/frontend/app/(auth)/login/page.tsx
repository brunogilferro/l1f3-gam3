...
import { Eye, EyeOff, LogIn, Shield, Sparkles, Star } from 'lucide-react';
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-bg-primary font-body">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(196,160,48,0.06) 0%, transparent 70%)',
        }}
      />
      <div
      ...
      >
        ...
        <div className="mb-6 flex flex-col items-center">
          <div className="relative mb-4 h-16 w-16">
            <div
              ...
              style={{
                background:
                  'radial-gradient(circle, rgba(42,32,16,1) 0%, rgba(26,21,8,1) 100%)',
              }}
            />
        ...
        <div className="w-full rounded-2xl border border-border-primary bg-bg-surface p-8 shadow-lg">
          <div className="mb-6 flex items-center gap-2">
            ...
            <h2 className="text-base tracking-wide text-text-primary">
              ENTRAR NA MESA
            </h2>
          </div>
